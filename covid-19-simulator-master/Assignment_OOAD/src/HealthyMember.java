...
//this is the sub class of member which create healthy member
public class HealthyMember extends Member{
    private String ID;
    private int Age;
    ...
    public HealthyMember(String id, int age, int el,boolean cdprob){
        this.ID=id;
        this.Age=age;
