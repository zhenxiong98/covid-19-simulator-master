//this is the sub class of member which create infected member

public class InfectedMember extends Member{
    private String ID;
    private int Age;
    ...
    public InfectedMember(String id, int age, int el,boolean cdprob){
        this.ID=id;
        this.Age=age;
        this.expectedLife=el;
        this.health=cdprob;
        this.c19Positive=true;
        this.quarantineDays=0;
        this.c19immune=false;
